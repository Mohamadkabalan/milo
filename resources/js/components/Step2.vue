    ...
    <div class="row">
      <div class="col">
        <div class="form-section">
          ...
          <div v-for="(question,index) in questions.slice(5, 10)" :key="index" class="row">
            <div class="question ml-sm-5 pl-sm-5 pt-2">
              <div class="py-2 h5"><b v-html="index + 6  + '.   '+ question.question + ' ?'"></b></div>
        ...
        <div class="form-actions">
          <div class="row">
            <div class="col">
              <span v-on:click="$emit('back')" class="btn btn-outline-gray"><i class="fas fa-chevron-left"></i>Back</span>
            </div>
            <div class="col text-right">
              <SubmitButton text="Finish" faIconRight="check" @clickEvent="submit" :loading="isLoading"></SubmitButton>
            </div>
          </div>
        </div>
